# GMT Example 04
#
# Purpose: 3-D mesh and color plot of Hawaiian topography and
# geoid
# GMT modules: colobar, grdcontour, grdimage, grdview, basemap,
# coast, text, makecpt
# Unix progs: echo, rm
#
# Composite figure of ETOPO5 bathymetry and Geosat geoid data
# sets which we have extracted from global grids using grdcut.
# Add an arrow pointing north and some text. One plot should
# be a contour map of the marine geoid and the other should
# be a 3-D perspective of the topography.
...
#
# GRDVIEW
# Can either plot mesh surface (ex04) or color surface (ex04c)
# Qc option gives high degree of smoothness
