...
#
# Trend modelling
# Basically an example of how to use trend1d

gmt begin ex45
gmt set FONT_HEADING 24p
gmt subplot begin 4x1 -Fs15c/4.8c -R1958/2016/310/410 -Bxaf -Byaf+u" ppm" \
	-BWSne+gazure1 -T"The Keeling Curve [CO@-2@- at Mauna Loa]"
...
gmt subplot set 1
gmt trend1d -Fxmr @MaunaLoa_CO2.txt -Np2,f1+o1985+l1 > model.txt
gmt plot -Sc0.05c -Gred @MaunaLoa_CO2.txt
gmt plot -W0.5p,blue model.txt
gmt text -F+f12p+cTL+t"m@-5@-(t) = a + b\267t + c\267t@+2@+ + d\267cos(2@~p@~t) + e\267sin(2@~p@~t)" \
	-Dj8p -Glightyellow
# Plot the residuals
gmt subplot set 0
