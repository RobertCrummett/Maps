...
# GMT Example 23
#
# Calculate the distance to Rome from anywhere
# on earth and contour the distances. Do this
# using grdmath and grdcontour
...
END
    gmt coast -Rg -JH90/25c -Glightgreen -Sblue -A1000 -Bg30 \
    ...
    # Sample the distance grid at the cities and use the distance in
    # integer km for labels
