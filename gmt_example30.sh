...
# GMT Example 30
#
# Trigonometric functions in graph mode

gmt begin ex30
# Draw generic X & Y axes with arrows
gmt basemap -R0/360/-1.25/1.75 -JX20c/15c -Bx90f30+u@. -By1g10 \
	-BWS+t"Two Trigonometric Functions" --MAP_FRAME_TYPE=graph \
...
# Draw a circle to indicate the 0-70 degree angle
...
-0.3333 0.6 12p,Times-Roman 30 LB 120@.
EOF
