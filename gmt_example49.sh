...
# GMT Example 49
#
# Analysis of the Atlantic Seafloor Depth/Age Relationship
...
gmt blockmode -R0/100/0/100 -I5/10 -r -E -Q depth-age.bin -bi3f -o0,2,3 > modal.txt
...
# depth(t) = 0.35b * sqrt(r) + 2.500, t < 70 Myr
# depth(t) = 6.4 - 3.2 * exp(-t / 62.8), t > 70 Myr
...
# depth(t) = 5.651 - 2.473 * exp(-0.0278 * t), t > 20 Myr
...
gmt legend -DjRT+w5.5+o0.25c -F+p1p+gbeige+s <<- EOF
S 0.5c - 0.9c - 4p,green 1.2c Parsons & Sclater (1977)
S 0.5c - 0.9c - 4p,white 1.2c Stein & Stein (1992)
S 0.5c s 0.4c blue - 1.2c Model depth estimates
EOF
