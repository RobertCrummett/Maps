...
# GMT Example 47
#
# GMT regression of different types and norms

function plot_one { # First 3 - 4 arguments are: -E -N -c [-Barg]
...
gmt subplot begin 4x3 -M0p -Fs5c -R2.85/5.25/3.9/6.3 -JX-5c/5c \
	-Srl+l"Log light intensity" -Scb+l"Log temperature"+tc -Bwesn -Bafg
# L1 regressions
